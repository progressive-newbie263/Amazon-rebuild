//note: very hard exercise, have to look at the answer a lot.
//expect that describe can't be defined then.
import {Product, Clothing, Appliance} from '../../data/products.js';

//TITLE / TESTING SUBJECTS
console.log('')
console.log('--------------------testing for 17i------------------');
console.log('test suite: products, clothing and appliances');
console.log('')//spacing minii


//test case 1
console.log('test case 1: product testing');
...
//test case 2
console.log('test case 2: Clothing testings');
...
//test case 3
console.log('test case 3: Appliance testings');
